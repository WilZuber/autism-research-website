...
export default function Home() {
  return [
    <div className="flex flex-col">
      ...
      <div className="flex-1 flex-col sticky top-0 w-screen bg-white justify-center">  {/* header */}
        ...
        <div className="flex flex-col">
          ...
          <nav className="flex-8 p-4 pl-6 bg-lightperiwinkle">
            <h1 className="text-white text-2xl mx-20">Language Around Autism - A Guide by Wilson Zuber</h1>
          </nav>
        </div>
      </div>
